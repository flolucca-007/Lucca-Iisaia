...
- `TP1/` — Evaluación de impacto ambiental EIQ en programas de fungicidas (papa)
- `TP2/` — (pendiente)
- `TP-final/` — (pendiente)

Cada carpeta incluye su propio README con la descripción específica del trabajo.
